...
today = Data('13 - 02 - 2023')
print(today)
print(Data.valid(10, 12, 2022))
print(today.valid(11, 12, 2021))
print(Data.extract('05 - 10 - 2011'))
print(today.extract('10 - 03 - 2020'))
print(Data.valid(10, 11, 2000))